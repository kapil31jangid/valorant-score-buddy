      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <footer className="py-6 px-4 border-t border-border/30">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground/70 font-display tracking-wider uppercase md:w-48">
              © IEEE SOU SB
            </p>
            ...
            <div className="flex items-center gap-6 flex-1 justify-center">
              ...
              >
                ...
                <span className="text-sm font-display uppercase tracking-wider">LinkedIn</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-display uppercase tracking-wider">Instagram</span>
              </a>
            </div>
